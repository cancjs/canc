  ...
  return (
    <main style={{ fontFamily: 'system-ui, sans-serif', maxWidth: 560, margin: '2rem auto', padding: '0 1rem' }}>
      ...
      <p style={{ color: '#555', fontSize: '0.9rem' }}>
        Pick a destination to load its details under Suspense, then pick another before it finishes. Open the console to
        watch the mock API log which detail requests get aborted.
      </p>
      {children}
    </main>
  );
