...
async function main(): Promise<void> {
 ...
 forDisplay.catch(() => {/* consumer-side cancellation, checked via pending.isCanceled below */});
 forPrefetch.catch(() => {/* consumer-side cancellation, checked via pending.isCanceled below */});
